...
import styles from '@styles/8ball.module.scss';
...
export default function _8ball() {
    ...
    function askQuestion(_question: string) {
        ...
        const randomType = ['affirmative', 'neutral', 'negative'][
            Math.floor(
                Math.random() * ['affirmative', 'neutral', 'negative'].length
            )
        ] as 'affirmative' | 'neutral' | 'negative';
